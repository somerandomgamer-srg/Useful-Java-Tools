...
public class Terminal {
	...
	public static String strInput(String prompt, String errorMessage) {
		try {
			...
			return strInput(prompt, errorMessage);
		}
	}
	 ...
	 * @return The integer input by the user.
	 */
	public static int loopVerifyRange(int min, int max, String prompt) {
		while (true) {
	 ...
	 * @return The long input by the user.
	 */
	public static long loopVerifyRange(long min, long max, String prompt) {
		while (true) {
	 ...
	 * @return The float input by the user.
	 */
	public static float loopVerifyRange(float min, float max, String prompt) {
		while (true) {
