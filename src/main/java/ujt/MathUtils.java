...
public class MathUtils {
	...
	*/
	public static double round(double x) {
		return Double.parseDouble(String.format("%.0f", Math.floor(x + 0.5)));
	}
	...
	/**
		...
		* @return The rounded number.
	*/
	public static double round(double x, long precision) {
		double mult = Math.pow(10, precision);
		return Double.parseDouble(String.format(String.format("%%.%df", precision), Math.floor(x * mult + 0.5) / mult));
	}
