...
public class Jvm {
	...
	/**
	 * Returns the total amount of memory currently reserved by the JVM from the host OS, in bytes.
	...
	/**
	 * Returns the amount of reserved memory that is currently available for new objects, in bytes.
	...
	/**
	 * Returns the amount of memory currently occupied by objects (Total - Free), in bytes.
